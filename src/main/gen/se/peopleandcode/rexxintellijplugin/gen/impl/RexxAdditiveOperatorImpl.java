...
public class RexxAdditiveOperatorImpl extends ASTWrapperPsiElement implements RexxAdditiveOperator {

  public RexxAdditiveOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
