...
public class RexxMultiplicativeOperatorImpl extends ASTWrapperPsiElement implements RexxMultiplicativeOperator {

  public RexxMultiplicativeOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
