...
public class RexxParsePullInstructionImpl extends ASTWrapperPsiElement implements RexxParsePullInstruction {

  public RexxParsePullInstructionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RexxVisitor visitor) {
    visitor.visitParsePullInstruction(this);
  }
