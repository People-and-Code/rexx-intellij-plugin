...
public class RexxParser implements PsiParser, LightPsiParser {
  ...
  static boolean additive_operator(PsiBuilder builder_, int level_) {
  ...
  // instruction | END
  private static boolean else_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "else_3")) return false;
    boolean result_;
  ...
  public static boolean instruction(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _COLLAPSE_, INSTRUCTION, "<instruction>");
    ...
    if (!result_) result_ = single_instruction(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }

  /* ********************************************************** */
  // instruction_with_ncl+
  static boolean instruction_list(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = instruction_with_ncl(builder_, level_ + 1);
    while (result_) {
      int pos_ = current_position_(builder_);
      if (!instruction_with_ncl(builder_, level_ + 1)) break;
  ...
  /* ********************************************************** */
  // instruction ncl
  static boolean instruction_with_ncl(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "instruction_with_ncl")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = instruction(builder_, level_ + 1);
    result_ = result_ && ncl(builder_, level_ + 1);
  ...
  //     | '//'
  //     | OPERATOR_REMAINDER
  static boolean multiplicative_operator(PsiBuilder builder_, int level_) {
  ...
  static boolean or_operator(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "or_operator")) return false;
    if (!nextTokenIs(builder_, "", OPERATOR_AND, OPERATOR_OR)) return false;
    boolean result_;
  ...
  /* ********************************************************** */
  // OTHERWISE ncl? /*ncl not optional in spec*/ instruction_with_ncl*
  ...
  /* ********************************************************** */
  // !terminator
  static boolean recoverParentheticalExpression(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "recoverParentheticalExpression")) return false;
    boolean result_;
  ...
  /* ********************************************************** */
  // REQUIRES taken_constant
  public static boolean requires_directive(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "requires_directive")) return false;
    if (!nextTokenIs(builder_, REQUIRES)) return false;
    boolean result_, pinned_;
    Marker marker_ = enter_section_(builder_, level_, _NONE_, REQUIRES_DIRECTIVE, null);
  ...
  // OPERATOR_CONCATENATE | &term_expr
  ...
  private static boolean concatenation_expr_0_1(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _AND_);
    result_ = term_expr(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }
