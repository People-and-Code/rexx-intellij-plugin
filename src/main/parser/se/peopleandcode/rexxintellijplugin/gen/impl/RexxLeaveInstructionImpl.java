...
public class RexxLeaveInstructionImpl extends RexxInstructionImpl implements RexxLeaveInstruction {

  public RexxLeaveInstructionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull RexxVisitor visitor) {
    visitor.visitLeaveInstruction(this);
  }
  ...
  public PsiElement getLeave() {
    return findNotNullChildByType(LEAVE);
  }
